...
if __name__ == '__main__':
    ...
    test_dataset = HACDOMAIN(split='test', cfg=cfg, cfg_flow=cfg_flow, use_kinetics_100=args.use_kinetics_100, audio_noise_type=args.audio_noise_type, video_noise_type=args.video_noise_type, use_random_noise=args.use_random_noise, datapath=args.datapath, datapath_open=args.datapath_open, use_video=args.use_video, use_flow=args.use_flow, use_audio=args.use_audio)
