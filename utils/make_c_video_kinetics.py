...
parser.add_argument('--train_file_name', type=str, default='.HAC-rgb-flow-audio/splits/Kinetics_test_100.txt', help='Type of corruption to apply')
...
#save_path = 'OSTTA/Kinetics50-C/video-C/'
save_path = args.save_path
save_path = os.path.join(save_path, args.corruption)

#save_path = 'dataset/OSTTA/Kinetics50-C/video-C/gaussian_noise_5'
...
for i in range(len(samples)):
    #input_video_path = 'dataset/video_datasets/Kinetics-600-train/' + samples[i]
